...
<div class="container mt-5">
  ...
  <div class="card-header d-flex justify-content-between p-0"><span>Amis</span> 
...
<div class="row">
<?php
   $pub=$db->prepare('SELECT * FROM user WHERE id!=?  ORDER BY id DESC');
   $pub->execute(array($_SESSION['id']));
      $verify=$pub->rowCount();
      if($verify>0){
          while($pub1=$pub->fetch()){
?>
<a href="message.php?id=<?=$pub1['id']?>#fin" class="nav-link">
<div class="col-12">
...
<img src="img/<?=$pub1['image']?>" alt="" class="d-block user-select-none img-user">
</div>
<?php
} ?>    
...
<div class="card text-white bg-danger mb-3" style="max-width: 20rem;">
  <div class="card-header">Pas d'amis'</div>
  <div class="card-body">
